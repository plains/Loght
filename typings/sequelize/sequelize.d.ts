...
declare module "sequelize"
{
    module sequelize {
        ...
        interface Sequelize extends SequelizeStaticAndInstance {
             ...
             */
            query(sql: string, callee?: Model<any, any>, options?: QueryOptions, replacements?: any): Promise<any>;

            query<TInstance, TPojo>(sql: string, callee?: Model<TInstance, TPojo>, options?: QueryOptions): Promise<any>;
             ...
             */
            transaction(callback: (transaction: Transaction) => boolean): Promise<Transaction>;
             ...
             *                  argument (overload available for error and transaction arguments too).
             */
            transaction(options?: TransactionOptions, callback?: (transaction: Transaction) => void): Promise<Transaction>;
        ...
        interface Model<TInstance, TPojo> extends Hooks, Associations {
             ...
             *                      Instances. See sequelize.query for options
             */
            find(id?: number, queryOptions?: QueryOptions): Promise<TInstance>;
             ...
             */
            findOrInitialize(where: any, defaults?: TPojo, options?: QueryOptions): Promise<[TInstance, boolean]>;
             ...
             */
            findOrCreate(options?: FindOrCreateOptions<TPojo>, queryOptions?: QueryOptions): Promise<[TInstance, boolean]>;
             ...
             *
             * @param values A hash of fields to change and their new values
             ...
             */
            update(values: TPojo, options?: UpdateOptions): Promise<void>;

            upsert(record: TPojo, options?: UpsertOptions): Promise<boolean>;
        ...
        interface Instance<TInstance, TPojo> {
             ...
             */
            save(options?: SaveOptions): Promise<TInstance>;
             ...
             */
            validate(options?: ValidateOptions): Promise<Error>;
             ...
             */
            destroy(options?: DestroyInstanceOptions): Promise<void>;

            restore(options?: RestoreInstanceOptions): Promise<void>;
             ...
             */
            increment(fields: any, options?: IncrementOptions): Promise<void>;
             ...
             */
            decrement(fields: any, options?: IncrementOptions): Promise<void>;
        ...
        interface Options {
            ...
            language?: string;
            /**
             * add by jKey Lu 2016-01-09
             * for update tsc to 1.7
             */
            dialectOptions?: any;
        ...
        interface QueryOptions {
            ...
            /**
             * Either an object of named parameter replacements in the format :param or an array of
             * unnamed replacements to replace ? in your SQL.
             */
            replacements?: any
        }
         ...
         * for update tsc to 1.7
         */
        interface CountOptions extends FindOptions {
            transaction?: Transaction;
        }
        ...
        interface FindOrCreateOptions<TPojo> {
            where: any;
            defaults?: TPojo;
        }
        ...
        interface RestoreInstanceOptions {
            transaction?: Transaction;
        }
        ...
        interface Promise<T> {
             ...
             * Listen for success events.
             */
            success(onSuccess: (t: T) => void): Promise<T>;

            /**
             * Alias for success(handler). Listen for success events.
             */
            ok(onSuccess: (t: T) => void): Promise<T>;
             ...
             */
            error(onError: (err?: Error) => void): Promise<T>;
             ...
             * @param onError Error handler.
             */
            fail(onError: (err?: Error) => void): Promise<T>;
             ...
             * @param onError Error handler.
             */
            failure(onError: (err?: Error) => void): Promise<T>;

            /**
             * Listen for both success and error events..
             */
            done(handler: (err: Error, result: T) => void): Promise<T>;

            /**
             * Alias for done(handler). Listen for both success and error events..
             */
            complete(handler: (err: Error, result: T) => void): Promise<T>;
             ...
             * @param onSQL
             */
            sql(onSQL: (sql: string) => void): Promise<T>;
             ...
             * @param options   Contains an array of the events to proxy. Defaults to sql, error and success
             */
            proxy(promise: Promise<T>, options?: ProxyOptions): Promise<T>;
             ...
             * @param onRejected
             */
            then<R>(onFulfilled: (value: T) => Thenable<R>|R, onRejected?: (reason: any) => any): Promise<R>;
             ...
             * @param onRejected
             */
            spread<R>(onFulfilled?: (...results: any[]) => Thenable<R>, onRejected?: (...results: any[]) => void): Promise<R>;

            /**
             * Shorthand for then(null, onRejected)
             */
            catch<R>(onRejected: (result?: T) => Thenable<R>): Promise<R>;
        }
